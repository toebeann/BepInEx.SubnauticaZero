...
executable_name="SubnauticaZero"
...
case $executable_type in
    *PE32*)
        ...
        echo "Configure Steam to launch the game with WINEDLLOVERRIDES as instructed in the README of Tobey's BepInEx Pack for Subnautica: Below Zero."
        echo "More info: https://github.com/toebeann/BepInEx.SubnauticaZero#configuration-on-linux-steamos-etc"
        exit 1
        ;;
    *64-bit*)
        arch="x64"
